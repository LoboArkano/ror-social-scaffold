...
RSpec.describe User, type: :model do
  ...
  context 'user methods' do
    ...
    let(:friendship_1) { Friendship.create(user_id: frodo.id, friend_id: bilbo.id, confirmed: true) }
    let(:friendship_2) { Friendship.create(user_id: frodo.id, friend_id: gandalf.id, confirmed: false) }
